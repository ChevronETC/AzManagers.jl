...
resourcegroup_vnet = ENV["RESOURCE_GROUP_VNET"]
resourcegroup_image = ENV["RESOURCE_GROUP_IMAGE"]
...
sstemplate = AzManagers.build_sstemplate(
        ...
        resourcegroup_vnet   = resourcegroup_vnet,
        resourcegroup_image  = resourcegroup_image,
        vnet                 = ENV["VNET_NAME"],
